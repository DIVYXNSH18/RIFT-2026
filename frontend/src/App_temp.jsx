  ...
  fixes: [
    {
      ...
      bugType: "LINTING",
      line: 42,
      commit: "fix: resolve unused import warnings in parser module",
      status: "Fixed",
    },
    {
      file: "tests/test_api.js",
      bugType: "SYNTAX",
      line: 17,
      commit: "fix: correct arrow function syntax in async test handler",
      status: "Fixed",
    },
  ],
  timeline: [
    {
      ...
      errors: 7,
      commits: [
        "a1b2c3d fix: initial linting fixes",
        "e4f5a6b fix: remove syntax errors in parser",
      ],
      errorList: [
        { file: "src/utils/parser.py", error: "Unused import warnings", status: "fixed" },
      ],
    },
  ],
};
...
const ScorePage = ({ results }) => (
  <div className="page-enter" style={{ maxWidth: 1200, margin: "0 auto", padding: "96px 48px 64px" }}>
    <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 40, fontWeight: 700, color: "#111110", marginBottom: 32 }}>
      Score Breakdown
    </h1>
    <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 24, marginBottom: 32 }}>
      <div style={{ background: "#fff", borderRadius: 20, padding: 32, boxShadow: "0 4px 16px rgba(0,0,0,0.08)" }}>
        <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "#6b6860", marginBottom: 12 }}>Base Score</div>
        <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 48, fontWeight: 700, color: "#2a2926" }}>{results.score.base}</div>
      </div>
      <div style={{ background: "#e8f5ef", borderRadius: 20, padding: 32, boxShadow: "0 4px 16px rgba(0,0,0,0.08)" }}>
        <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "#14784a", marginBottom: 12 }}>Speed Bonus</div>
        <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 48, fontWeight: 700, color: "#14784a" }}>+{results.score.speedBonus}</div>
      </div>
      <div style={{ background: "#fdf0ef", borderRadius: 20, padding: 32, boxShadow: "0 4px 16px rgba(0,0,0,0.08)" }}>
        <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, color: "#c0392b", marginBottom: 12 }}>Efficiency Penalty</div>
        <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 48, fontWeight: 700, color: "#c0392b" }}>{results.score.efficiencyPenalty}</div>
      </div>
    </div>
    <div style={{ background: "linear-gradient(135deg, #2a2926 0%, #111110 100%)", borderRadius: 20, padding: 48, textAlign: "center" }}>
      <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 16, color: "rgba(255,255,255,0.7)", marginBottom: 16 }}>Final Score</div>
      <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 72, fontWeight: 700, color: "#fff" }}>{results.score.total}</div>
    </div>
  </div>
);
